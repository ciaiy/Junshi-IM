...
CJsonObject CJsonObject::getCJsonObject(const std::string &strKey, CJsonObject &oJsonObject) const
{
    CJsonObject ret;
...
std::string CJsonObject::getString(const std::string &strKey, std::string &strValue) const
{
    std::string ret;
    if (Get(strKey, ret) == false)
    {
...
int32 CJsonObject::geyInt32(const std::string &strKey, int32 &iValue) const
{
    int32 ret;
    if (Get(strKey, ret) == false)
    {
...
uint32 CJsonObject::getUInt32(const std::string &strKey, uint32 &uiValue) const
{
    uint32 ret;
    if (Get(strKey, ret) == false)
    {
...
int64 CJsonObject::getInt64(const std::string &strKey, int64 &llValue) const
{
    int64 ret;
    if (Get(strKey, ret) == false)
    {
...
uint64 CJsonObject::getUInt64(const std::string &strKey, uint64 &ullValue) const
{
    uint64 ret;
    if (Get(strKey, ret) == false)
    {
...
bool CJsonObject::getBool(const std::string &strKey, bool &bValue) const
{
    bool ret;
    if (Get(strKey, ret) == false)
    {
...
float CJsonObject::getFloat(const std::string &strKey, float &fValue) const
{
    float ret;
    if (Get(strKey, ret) == false)
    {
...
double CJsonObject::getDouble(const std::string &strKey, double &dValue) const
{
    double ret;
    if (Get(strKey, ret) == false)
    {
