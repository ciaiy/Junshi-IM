...
std::string CJsonObject::getString(const std::string &strKey) const
{
    std::string ret;
    if (Get(strKey, ret) == false)
    {
...
uint32 CJsonObject::getUInt32(const std::string &strKey) const
{
    uint32 ret;
    if (Get(strKey, ret) == false)
    {
...
int64 CJsonObject::getInt64(const std::string &strKey) const
{
    int64 ret;
    if (Get(strKey, ret) == false)
    {
...
uint64 CJsonObject::getUInt64(const std::string &strKey) const
{
    uint64 ret;
    if (Get(strKey, ret) == false)
    {
...
bool CJsonObject::getBool(const std::string &strKey) const
{
    bool ret;
    if (Get(strKey, ret) == false)
    {
...
float CJsonObject::getFloat(const std::string &strKey) const
{
    float ret;
    if (Get(strKey, ret) == false)
    {
...
double CJsonObject::getDouble(const std::string &strKey) const
{
    double ret;
    if (Get(strKey, ret) == false)
    {
